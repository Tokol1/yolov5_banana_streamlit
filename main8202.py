...
model = torch.hub.load("yolov5", 'custom', path='C:\\Users\\81801\\OneDrive\\ドキュメント\\GitHub\\yolov5_banana_streamlit\\yolov5\\runs\\train\\exp2\\weights\\best1.pt',source='local')
